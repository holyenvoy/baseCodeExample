...
const (
	DefaultKafkaTopics   = "AllenbinlogData"
	DefaultConsumerGroup = "binlog"
)
...
var (
	...
	zookeeper      = flag.String("zookeeper", "172.16.60.28:2181", "A comma-separated Zookeeper connection string (e.g. `zookeeper1.local:2181,zookeeper2.local:2181,zookeeper3.local:2181`)")
...
func main() {
	...
	fmt.Println("kafkaTopics:", kafkaTopics)
	fmt.Println("zookeeperNodes:", zookeeperNodes)
	fmt.Println("config.Zookeeper.Chroot:", config.Zookeeper.Chroot)
